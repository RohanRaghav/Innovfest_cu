...
export default function LeaderboardPage() {
  ...
  return (
    <div className="min-h-screen py-20 px-4 bg-gradient-to-br 
  from-[#cfe0f6] 
  via-[#c9def7] 
  via-[#dee4f3] 
  via-[#e1e5f2] 
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
          ...
          <div className="relative w-full md:w-80">
            ...
            <Input placeholder="Search ambassadors..." className="pl-10 h-12 rounded-xl bg-muted/30 border-none" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 items-end">
          ...
          >
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm relative overflow-hidden pt-12 pb-8 px-6 text-center">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 h-16 w-16 rounded-full bg-slate-300 flex items-center justify-center border-4 border-background text-2xl font-black">
                2
              </div>
          ...
          >
            <Card className="border-primary/30 bg-primary/5 backdrop-blur-sm relative overflow-hidden pt-16 pb-10 px-6 text-center shadow-2xl shadow-primary/20 scale-105">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 h-20 w-20 rounded-full bg-yellow-400 flex items-center justify-center border-4 border-background text-3xl font-black text-white animate-glow">
                1
              </div>
              ...
              <h3 className="font-black text-2xl mb-1">{podium[0].name}</h3>
              <p className="text-sm font-bold text-primary mb-6">{podium[0].zone} Zone</p>
              <div className="text-4xl font-black text-primary">{podium[0].points} PTS</div>
            </Card>
          </motion.div>
          ...
          >
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm relative overflow-hidden pt-12 pb-8 px-6 text-center">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 h-16 w-16 rounded-full bg-amber-600/40 flex items-center justify-center border-4 border-background text-2xl font-black">
                3
              </div>
